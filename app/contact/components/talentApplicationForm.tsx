...
const TalentApplicationForm = () => {
  ...
  return (
    <React.Fragment>
      ...
      <Card
        classNames={{ base: "w-full md:max-w-md " }}
        isBlurred
        shadow="none"
        radius="none"
      >
        {!isSubmitted ? (
          <form className=" flex flex-col gap-4 " onSubmit={handleSubmit}>
            ...
            <Input
              ...
              errorMessage={
                isInvalidLastName ? "Please enter your last name" : ""
              }
            ...
            <Input
              ...
              errorMessage={isInvalidAddress ? "Please enter your address" : ""}
            ...
            <Input
              ...
              errorMessage={
                isInvalidStateProvince ? "Please enter your state/province" : ""
              }
            ...
            <Input
              ...
              errorMessage={isInvalidCountry ? "Please enter your country" : ""}
