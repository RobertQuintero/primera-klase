              ...
              <Section className="px-2">
                ...
                <Row>
                  ...
                  <div className="flex mb-0.5 p-[1px] w-full">
                    ...
                    <div className=" m-0 pl-4 w-full">
                      <p className="text-gray-500 text-xs mt-1 mb-0">Pants Size</p>
                      <p className="text-black text-sm my-1 font-bold ">
                        {pantsSize}
                      </p>
                    </div>
                  ...
                  <div className="flex mb-0.5 p-[1px] w-full">
                  <div className=" m-0 pl-4 w-full">
                      <p className="text-gray-500 text-xs mt-1 mb-0">Dress Size</p>
                      <p className="text-black text-sm my-1 font-bold ">
                        {dressSize}
                      </p>
                    </div>
                    <div className=" m-0 pl-4 w-full">
                    <p className="text-gray-500 text-xs mt-1 mb-0">Shoe Size</p>
                      <p className="text-black text-sm my-1 font-bold ">
                        {shoeSize}
                      </p>
                    </div>
